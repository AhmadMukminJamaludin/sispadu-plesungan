<div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item"><a class="nav-link" href="{{ route('welcome.profile') }}">Profil Desa</a></li>
        <li class="nav-item"><a class="nav-link" href="{{ route('welcome.kegiatan') }}">Kegiatan</a></li>
        @auth
